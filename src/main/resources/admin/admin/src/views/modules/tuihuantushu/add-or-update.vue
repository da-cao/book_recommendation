  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="学号" prop="xuehao">
              <el-input v-model="ruleForm.xuehao" 
                placeholder="学号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="退换类型" prop="tuihuanleixing">
          <el-select v-model="ruleForm.tuihuanleixing" placeholder="请选择退换类型">
            <el-option
                v-for="(item,index) in tuihuanleixingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="退换类型" prop="tuihuanleixing">
	      <el-input v-model="ruleForm.tuihuanleixing"
                placeholder="退换类型" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.riqi" label="日期" prop="riqi">
              <el-input v-model="ruleForm.riqi" 
                placeholder="日期" readonly></el-input>
                                                                                                                          ...
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="退换原因" prop="tuihuanyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="退换原因"
                  v-model="ruleForm.tuihuanyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tuihuanyuanyin" label="退换原因" prop="tuihuanyuanyin">
                    <span>{{ruleForm.tuihuanyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	shuliang : false,
	xuehao : false,
	tuihuanleixing : false,
	tuihuanyuanyin : false,
	riqi : false,
	sfsh : false,
	shhf : false,
      },
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuehao = true;
            continue;
	            	            ...
	            	            if(o=='tuihuanleixing'){
            this.ruleForm.tuihuanleixing = obj[o];
	    this.ro.tuihuanleixing = true;
            continue;
          }
	            	            if(o=='tuihuanyuanyin'){
            this.ruleForm.tuihuanyuanyin = obj[o];
	    this.ro.tuihuanyuanyin = true;
            continue;
          }
	            	            if(o=='riqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                      ...
                                                                                                                                                      this.tuihuanleixingOptions = "退书,换书".split(',')
                                                                                                    },
                                                                                                // 多级联动参数
                                                                                                                          info(id) {
      this.$http({
        url: `tuihuantushu/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tuihuantushu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tuihuantushuCrossAddOrUpdateFlag = false;
                  this.parent.search();
