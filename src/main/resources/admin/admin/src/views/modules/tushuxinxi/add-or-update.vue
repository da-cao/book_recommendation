          ...
          <el-form-item class="input" label="图书名称" prop="tushumingcheng">
              <el-input v-model="ruleForm.tushumingcheng" 
                placeholder="图书名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="图书类别" prop="tushuleibie">
          <el-select v-model="ruleForm.tushuleibie" placeholder="请选择图书类别">
            <el-option
                v-for="(item,index) in tushuleibieOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
