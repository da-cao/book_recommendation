          ...
          <el-form-item class="input" label="图书名称" prop="tushumingcheng">
              <el-input v-model="ruleForm.tushumingcheng" 
                placeholder="图书名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="图书类别" prop="tushuleibie">
          <el-input v-model="ruleForm.tushuleibie" 
              placeholder="图书类别" clearable  :readonly="ro.tushuleibie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="图书类别" prop="tushuleibie">
              <el-input v-model="ruleForm.tushuleibie" 
                placeholder="图书类别" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='tushuleibie'){
            this.ruleForm.tushuleibie = obj[o];
	    this.ro.tushuleibie = true;
            continue;
          }
	            	            if(o=='zuozhe'){
    ...
    onSubmit() {
      ...
      this.$http({
        ...
        if (valid) {
          this.$http({
            url: `tushuyuyue/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tushuyuyueCrossAddOrUpdateFlag = false;
                  this.parent.search();
